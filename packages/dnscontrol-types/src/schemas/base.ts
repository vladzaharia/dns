...
export const TtlSchema = z.union([
  ...
  z.string().regex(/^\d+[smhdw]?$/, {
    error: 'Invalid TTL format. Use number or duration string (e.g., "300", "5m", "1h")',
  }),
]);
 ...
 */
export const IpAddressSchema = z.union([Ipv4AddressSchema, Ipv6AddressSchema, z.number()]);
 ...
 */
export const PseudoRecordTypeSchema = z.enum(["ALIAS", "DHCID", "FRAME", "RP", "URL", "URL301"]);
