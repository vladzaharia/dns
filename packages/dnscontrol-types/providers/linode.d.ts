/**
 * DNSControl Linode Provider Types
 * Linode DNS-specific functions and modifiers
 *
 * @provider LINODE
 * @maintainer @koesie10
 *
...
/**
 * Linode DNS provider capability interface
 * Extends BaseProviderCapabilities to inherit documentation
 */
export interface LinodeCapabilities extends BaseProviderCapabilities {
...
// =============================================================================
// LINODE NAMESPACE (STRICT MODE)
// =============================================================================

/**
 * Linode DNS namespace with compile-time validation
 * Only includes record types supported by Linode
 */
