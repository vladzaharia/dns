/**
 * DNSControl Oracle Cloud Infrastructure DNS Provider Types
 * Oracle Cloud DNS-specific functions and modifiers
 *
 * @provider ORACLE
 * @maintainer @kallsyms
 *
...
/**
 * Oracle Cloud DNS provider capability interface
 * Extends BaseProviderCapabilities to inherit documentation
 */
export interface OracleCapabilities extends BaseProviderCapabilities {
...
// =============================================================================
// ORACLE NAMESPACE (STRICT MODE)
// =============================================================================

/**
 * Oracle Cloud DNS namespace with compile-time validation
 * Only includes record types supported by Oracle
 */
