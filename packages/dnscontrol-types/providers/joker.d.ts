/**
 * DNSControl Joker Provider Types
 * Joker DNS-specific functions and modifiers
 *
 * @provider JOKER
...
/**
 * Joker DNS provider capability interface
 * Extends BaseProviderCapabilities to inherit documentation
 */
export interface JokerCapabilities extends BaseProviderCapabilities {
...
// =============================================================================
// JOKER NAMESPACE (STRICT MODE)
// =============================================================================

/**
 * Joker DNS namespace with compile-time validation
 * Only includes record types supported by Joker
 */
export namespace Joker {
