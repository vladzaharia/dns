/**
 * DNSControl Hetzner DNS Provider Types (Legacy)
 * Hetzner DNS Console-specific functions and modifiers
 *
 * @provider HETZNER
 * @maintainer @das7pad
 *
 * @note This is the legacy Hetzner DNS Console provider
 * @note Consider using HETZNERV2 for the newer Hetzner DNS API
 *
...
/**
 * Hetzner DNS provider capability interface (Legacy)
 * Extends BaseProviderCapabilities to inherit documentation
 */
export interface HetznerCapabilities extends BaseProviderCapabilities {
...
// =============================================================================
// HETZNER NAMESPACE (STRICT MODE)
// =============================================================================

/**
 * Hetzner DNS namespace with compile-time validation
 * Only includes record types supported by Hetzner
 */
