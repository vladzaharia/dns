/**
 * DNSControl Mythic Beasts Provider Types
 * Mythic Beasts DNS-specific functions and modifiers
 *
...
// =============================================================================
// MYTHICBEASTS CAPABILITIES
// =============================================================================

/**
 * Mythic Beasts DNS provider capability interface
 * Extends BaseProviderCapabilities to inherit documentation
 */
export interface MythicbeastsCapabilities extends BaseProviderCapabilities {
...
// =============================================================================
// MYTHICBEASTS NAMESPACE (STRICT MODE)
// =============================================================================

/**
 * Mythic Beasts DNS namespace with compile-time validation
 * Only includes record types supported by Mythic Beasts
 */
export namespace Mythicbeasts {
