/**
 * DNSControl DNScale Provider Types
 * DNScale DNS-specific functions and modifiers
 *
 * @provider DNSCALE
 * @maintainer @Ozzyz
 *
...
// =============================================================================
// DNSCALE CAPABILITIES
// =============================================================================

/**
 * DNScale DNS provider capability interface
 * Extends BaseProviderCapabilities to inherit documentation
 */
export interface DnscaleCapabilities extends BaseProviderCapabilities {
...
// =============================================================================
// DNSCALE NAMESPACE (STRICT MODE)
// =============================================================================

/**
 * DNScale DNS namespace with compile-time validation
 * Only includes record types supported by DNScale
 */
export namespace Dnscale {
