/**
 * DNSControl BIND Provider Types
 * BIND DNS Server-specific functions and modifiers
 *
 * @provider BIND
 * @maintainer @tlimoncelli
 *
 * @note Generates zone files for BIND DNS server
 * @note Supports all standard DNS record types
 * @note File-based provider (no API)
 *
...
/**
 * BIND DNS provider capability interface
 * Extends BaseProviderCapabilities to inherit documentation
 */
export interface BindCapabilities extends BaseProviderCapabilities {
...
// =============================================================================
// BIND NAMESPACE (STRICT MODE)
// =============================================================================

/**
 * BIND DNS namespace with compile-time validation
 * Only includes record types supported by BIND
 */
