/**
 * DNSControl Domainnameshop Provider Types
 * Domainnameshop DNS-specific functions and modifiers
 *
...
// =============================================================================
// DOMAINNAMESHOP CAPABILITIES
// =============================================================================

/**
 * Domainnameshop DNS provider capability interface
 * Extends BaseProviderCapabilities to inherit documentation
 */
export interface DomainnameshopCapabilities extends BaseProviderCapabilities {
...
// =============================================================================
// DOMAINNAMESHOP NAMESPACE (STRICT MODE)
// =============================================================================

/**
 * Domainnameshop DNS namespace with compile-time validation
 * Only includes record types supported by Domainnameshop
 */
export namespace Domainnameshop {
