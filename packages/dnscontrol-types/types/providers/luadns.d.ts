/**
 * DNSControl LuaDNS Provider Types
 * LuaDNS-specific functions and modifiers
 *
 * @provider LUADNS
...
/**
 * LuaDNS provider capability interface
 * Extends BaseProviderCapabilities to inherit documentation
 */
export interface LuadnsCapabilities extends BaseProviderCapabilities {
...
// =============================================================================
// LUADNS NAMESPACE (STRICT MODE)
// =============================================================================

/**
 * LuaDNS namespace with compile-time validation
 * Only includes record types supported by LuaDNS
 */
export namespace Luadns {
