/**
 * DNSControl Hurricane Electric DNS Provider Types
 * HEDNS-specific functions and modifiers
 *
 * @provider HEDNS
...
/**
 * Hurricane Electric DNS provider capability interface
 * Extends BaseProviderCapabilities to inherit documentation
 */
export interface HednsCapabilities extends BaseProviderCapabilities {
...
// =============================================================================
// HEDNS NAMESPACE (STRICT MODE)
// =============================================================================

/**
 * Hurricane Electric DNS namespace with compile-time validation
 * Only includes record types supported by HEDNS
 */
export namespace Hedns {
  // Standard record types
  ...
  // HEDNS-specific
  export function HEDNS_NULL_MX(): DomainModifier;
}

// =============================================================================
// HEDNS NULL MX (GLOBAL)
// =============================================================================
