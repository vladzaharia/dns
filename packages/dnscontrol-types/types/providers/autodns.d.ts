/**
 * DNSControl AutoDNS Provider Types
 * AutoDNS-specific functions and modifiers
 *
 * @provider AUTODNS
 * @maintainer @papakai
 *
...
// =============================================================================
// AUTODNS CAPABILITIES
// =============================================================================

/**
 * AutoDNS provider capability interface
 * Extends BaseProviderCapabilities to inherit documentation
 */
export interface AutodnsCapabilities extends BaseProviderCapabilities {
...
// =============================================================================
// AUTODNS NAMESPACE (STRICT MODE)
// =============================================================================

/**
 * AutoDNS namespace with compile-time validation
 * Only includes record types supported by AutoDNS
 */
export namespace Autodns {
