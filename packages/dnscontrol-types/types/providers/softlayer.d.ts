/**
 * DNSControl SoftLayer DNS Provider Types
 * SoftLayer (IBM Cloud) DNS-specific functions and modifiers
 *
 * @provider SOFTLAYER
 * @maintainer @jamesdphillips
 *
...
// =============================================================================
// SOFTLAYER CAPABILITIES
// =============================================================================

/**
 * SoftLayer (IBM Cloud) DNS provider capability interface
 * Extends BaseProviderCapabilities to inherit documentation
 */
export interface SoftlayerCapabilities extends BaseProviderCapabilities {
...
// =============================================================================
// SOFTLAYER NAMESPACE (STRICT MODE)
// =============================================================================

/**
 * SoftLayer (IBM Cloud) DNS namespace with compile-time validation
 * Only includes record types supported by SoftLayer
 */
export namespace Softlayer {
