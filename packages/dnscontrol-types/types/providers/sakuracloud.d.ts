/**
 * DNSControl Sakura Cloud DNS Provider Types
 * Sakura Cloud DNS-specific functions and modifiers
 *
...
// =============================================================================
// SAKURACLOUD CAPABILITIES
// =============================================================================

/**
 * Sakura Cloud DNS provider capability interface
 * Extends BaseProviderCapabilities to inherit documentation
 */
export interface SakuracloudCapabilities extends BaseProviderCapabilities {
...
// =============================================================================
// SAKURACLOUD NAMESPACE (STRICT MODE)
// =============================================================================

/**
 * Sakura Cloud DNS namespace with compile-time validation
 * Only includes record types supported by Sakura Cloud
 */
export namespace Sakuracloud {
