/**
 * DNSControl ClouDNS Provider Types
 * ClouDNS-specific functions and modifiers
 *
 * @provider CLOUDNS
...
/**
 * ClouDNS provider capability interface
 * Extends BaseProviderCapabilities to inherit documentation
 */
export interface ClouDnsCapabilities extends BaseProviderCapabilities {
...
// =============================================================================
// CLOUDNS NAMESPACE (STRICT MODE)
// =============================================================================

/**
 * ClouDNS namespace with compile-time validation
 * Only includes record types supported by ClouDNS
 */
export namespace ClouDns {
  // Standard record types
  ...
  // ClouDNS-specific
  export function CLOUDNS_WR(name: string, target: string, options?: { redirectType?: 301 | 302; frame?: boolean; savePath?: boolean; }): DomainModifier;
}

// =============================================================================
// CLOUDNS WEB REDIRECT (GLOBAL)
// =============================================================================
