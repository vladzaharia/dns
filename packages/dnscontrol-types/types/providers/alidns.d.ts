/**
 * DNSControl AliDNS (Alibaba Cloud) Provider Types
 * AliDNS-specific functions and modifiers
 *
 * @provider ALIDNS
 * @maintainer @zhsj
 *
...
/**
 * AliDNS (Alibaba Cloud) provider capability interface
 * Extends BaseProviderCapabilities to inherit documentation
 */
export interface AlidnsCapabilities extends BaseProviderCapabilities {
...
// =============================================================================
// ALIDNS NAMESPACE (STRICT MODE)
// =============================================================================

/**
 * AliDNS (Alibaba Cloud) namespace with compile-time validation
 * Only includes record types supported by AliDNS
 */
export namespace Alidns {
