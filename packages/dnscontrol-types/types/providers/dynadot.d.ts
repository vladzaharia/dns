/**
 * DNSControl Dynadot Provider Types
 * Dynadot DNS-specific functions and modifiers
 *
 * @provider DYNADOT
 * @maintainer @philhug
 *
...
// =============================================================================
// DYNADOT CAPABILITIES
// =============================================================================

/**
 * Dynadot DNS provider capability interface
 * Extends BaseProviderCapabilities to inherit documentation
 */
export interface DynadotCapabilities extends BaseProviderCapabilities {
...
// =============================================================================
// DYNADOT NAMESPACE (STRICT MODE)
// =============================================================================

/**
 * Dynadot DNS namespace with compile-time validation
 * Only includes record types supported by Dynadot
 */
export namespace Dynadot {
