/**
 * DNSControl OVH Provider Types
 * OVH DNS-specific functions and modifiers
 *
 * @provider OVH
...
/**
 * OVH DNS provider capability interface
 * Extends BaseProviderCapabilities to inherit documentation
 */
export interface OvhCapabilities extends BaseProviderCapabilities {
...
// =============================================================================
// OVH NAMESPACE (STRICT MODE)
// =============================================================================

/**
 * OVH DNS namespace with compile-time validation
 * Only includes record types supported by OVH
 */
