/**
 * DNSControl HEXONET Provider Types
 * HEXONET DNS-specific functions and modifiers
 *
 * @provider HEXONET
 * @maintainer @papakai
 *
...
// =============================================================================
// HEXONET CAPABILITIES
// =============================================================================

/**
 * HEXONET DNS provider capability interface
 * Extends BaseProviderCapabilities to inherit documentation
 */
export interface HexonetCapabilities extends BaseProviderCapabilities {
...
// =============================================================================
// HEXONET NAMESPACE (STRICT MODE)
// =============================================================================

/**
 * HEXONET DNS namespace with compile-time validation
 * Only includes record types supported by HEXONET
 */
export namespace Hexonet {
