/**
 * DNSControl Exoscale Provider Types
 * Exoscale DNS-specific functions and modifiers
 *
 * @provider EXOSCALE
 * @maintainer @pierre-emmanuelJ
 *
...
// =============================================================================
// EXOSCALE CAPABILITIES
// =============================================================================

/**
 * Exoscale DNS provider capability interface
 * Extends BaseProviderCapabilities to inherit documentation
 */
export interface ExoscaleCapabilities extends BaseProviderCapabilities {
...
// =============================================================================
// EXOSCALE NAMESPACE (STRICT MODE)
// =============================================================================

/**
 * Exoscale DNS namespace with compile-time validation
 * Only includes record types supported by Exoscale
 */
export namespace Exoscale {
