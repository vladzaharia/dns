/**
 * DNSControl Netcup Provider Types
 * Netcup DNS-specific functions and modifiers
 *
 * @provider NETCUP
...
/**
 * Netcup DNS provider capability interface
 * Extends BaseProviderCapabilities to inherit documentation
 */
export interface NetcupCapabilities extends BaseProviderCapabilities {
...
// =============================================================================
// NETCUP NAMESPACE (STRICT MODE)
// =============================================================================

/**
 * Netcup DNS namespace with compile-time validation
 * Only includes record types supported by Netcup
 */
export namespace Netcup {
