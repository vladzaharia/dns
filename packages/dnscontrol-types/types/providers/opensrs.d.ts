/**
 * DNSControl OpenSRS Provider Types
 * OpenSRS DNS-specific functions and modifiers
 *
 * @provider OPENSRS
 * @maintainer @philhug
 *
...
// =============================================================================
// OPENSRS CAPABILITIES
// =============================================================================

/**
 * OpenSRS DNS provider capability interface
 * Extends BaseProviderCapabilities to inherit documentation
 */
export interface OpensrsCapabilities extends BaseProviderCapabilities {
...
// =============================================================================
// OPENSRS NAMESPACE (STRICT MODE)
// =============================================================================

/**
 * OpenSRS DNS namespace with compile-time validation
 * Only includes record types supported by OpenSRS
 */
export namespace Opensrs {
