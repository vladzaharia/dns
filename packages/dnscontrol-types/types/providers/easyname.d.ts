/**
 * DNSControl Easyname Provider Types
 * Easyname DNS-specific functions and modifiers
 *
 * @provider EASYNAME
 * @maintainer @tresni
 *
...
// =============================================================================
// EASYNAME CAPABILITIES
// =============================================================================

/**
 * Easyname DNS provider capability interface
 * Extends BaseProviderCapabilities to inherit documentation
 */
export interface EasynameCapabilities extends BaseProviderCapabilities {
...
// =============================================================================
// EASYNAME NAMESPACE (STRICT MODE)
// =============================================================================

/**
 * Easyname DNS namespace with compile-time validation
 * Only includes record types supported by Easyname
 */
export namespace Easyname {
