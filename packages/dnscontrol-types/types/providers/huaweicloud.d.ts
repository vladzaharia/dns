/**
 * DNSControl Huawei Cloud DNS Provider Types
 * Huawei Cloud DNS-specific functions and modifiers
 *
...
// =============================================================================
// HUAWEICLOUD CAPABILITIES
// =============================================================================

/**
 * Huawei Cloud DNS provider capability interface
 * Extends BaseProviderCapabilities to inherit documentation
 */
export interface HuaweicloudCapabilities extends BaseProviderCapabilities {
...
// =============================================================================
// HUAWEICLOUD NAMESPACE (STRICT MODE)
// =============================================================================

/**
 * Huawei Cloud DNS namespace with compile-time validation
 * Only includes record types supported by Huawei Cloud
 */
export namespace Huaweicloud {
